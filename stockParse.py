...
def rqstStockTSDataDaily(sym):
    ...
    while not r and tries < maxTries:
        r = requests.get(APIbase, params = {"function": "TIME_SERIES_DAILY", "symbol": sym, "outputsize": "full", "apikey": APIKey})
        tries += 1
...
def updateJSON_prices(fName, sym):
